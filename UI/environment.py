    ...
    if list_pos == 90:
        ...
        if rando_col + 1 < 10:
            ...
            if checkEmpty(list_pos, "E"):
                pygame.draw.circle(screen, (232, 15, 0),
                                   (((rando_col + 1) * 60 + 52 + 12), ((rando_row) * 60 + 12 + 12)), 10)
        if rando_col - 1 >= 0:
            board[list_pos - 1].append(stench)
        ...
        if rando_row + 1 < 10:
            ...
            if checkEmpty(list_pos, "S"):
                pygame.draw.circle(screen, (232, 15, 0),
                                   (((rando_col) * 60 + 52 + 12), ((rando_row + 1) * 60 + 12 + 12)),
                                   10)
        if rando_row - 1 >= 0:
            board[list_pos - 10].append(stench)
...
def setPits(screen, pit_pic):
    ...
    while (x < max_pit):
        ...
        if list_pos == 90 or board[list_pos].count("wumpus") > 0 or board[list_pos].count("pit") > 0 or board[
            list_pos].count("treasure") > 0:
            continue
...
def recreateEnv(screen):
    ...
    for i in range(0, 100):
        ...
        if board[i].count("wumpus") > 0:
            screen.blit(wum_pic, ((((i % 10) * 60 + 52), ((i // 10) * 60) + 12)))  # module - col, div - row
